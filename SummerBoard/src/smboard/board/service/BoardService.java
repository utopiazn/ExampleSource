...
public class BoardService implements BoardDao{
	...
	@Override
	public List<BoardModel> getBoardList(int startArticleNum, int showArticleLimit) {
		// TODO Auto-generated method stub
		
		valueMap.put("startArticleNum", startArticleNum);
		valueMap.put("endArticleNum", showArticleLimit);
		
		
		List<BoardModel> a = sqlMapClientTemplate.queryForList("board.getBoardList",valueMap);
	...
	public List<BoardModel> searchArticle(String type, String keyword, int startArticleNum, int endArticleNum) {
		...
		valueMap.put("startArticleNum", startArticleNum);
		valueMap.put("endArticle", endArticleNum);
